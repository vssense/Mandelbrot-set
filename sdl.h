...
static const int x_size = 1024;
static const int y_size = 512;
static const int x_top_left_corner = 1900 / 2 - x_size / 2;
...
static const float screen_scale_factor = 1.4;
static const float screen_num_pixels_to_move = 10;
